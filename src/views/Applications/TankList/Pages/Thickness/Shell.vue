    ...
    <div class="page-section" v-if="tabCurrent == 'A1'">
      ...
      <div class="table-wrapper">
        ...
        >
          ...
          <DxColumn data-field="course_no" caption="Shell course" :min-width="80" />
        ...
        <div class="table-header-toolbar" :style="px">
          ...
          <div class="right">
            <div class="dx-table-style">
              <div class="table-toolbar-set">
                <div class="download-btn">
                  <v-ons-toolbar-button id="toolbarBTN" v-on:click="FETCH_FILE_SHELL()">
...
export default {
  ...
  methods: {
    ...
    FETCH_FILE_SHELL() {
      ...
      axios({
        method: "get",
        url: "shell-thickness/download-shell-thk?id_tag=" + id_tag,
        responseType: "blob",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        }
    ...
    CREATE_ADDITIONAL_REMARK(e) {
      ...
      formData.append("remark_type", "shell_thk");
