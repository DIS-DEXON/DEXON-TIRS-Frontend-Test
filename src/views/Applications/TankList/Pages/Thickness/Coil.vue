    ...
    <div class="page-section" v-if="tabCurrent == 'A1'">
      ...
      <div class="table-wrapper">
        ...
        >
          ...
          <DxColumn data-field="coil_no" caption="Coil No." :min-width="80" />

          <DxColumn data-field="cml_name" caption="CML name" :min-width="80" />
          ...
          <DxColumn data-field="scr" caption="SCR (mm/yr)" format="#,##0.00" :min-width="80" />
        ...
        <div class="table-header-toolbar" style="width: calc(100% - 82px)">
          ...
          <div class="right">
            <div class="dx-table-style">
              <div class="table-toolbar-set">
                <div class="download-btn">
                  <v-ons-toolbar-button id="toolbarBTN" v-on:click="FETCH_FILE_COIL()">
...
export default {
  ...
  methods: {
    ...
    CREATE_CML(e) {
      ...
      e.data.id_tag = id_tag;
      e.data.id_cml = 0;
      e.data.id_coil = this.current_view_item.id_coil;
    ...
    FETCH_FILE_COIL() {
      ...
      axios({
        method: "get",
        url: "coil-thickness/download-coil-thk?id_tag=" + id_tag,
        responseType: "blob",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        }
        ...
        .then(res => {
          const blob = res.data;
          this.downLoadFileExcel(blob, "Coil_TP_TEMPLATE");
        })
        .catch(error => {
          console.log(error);
        })
    ...
    FETCH_FILE_CML() {
      ...
      axios({
        method: "get",
        url: "coil-thickness/download-coil-cml?id_tag=" + id_tag,
        responseType: "blob",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        }
        ...
        .then(res => {
          const blob = res.data;
          this.downLoadFileExcel(blob, "Coil_CML_TEMPLATE");
        })
        .catch(error => {
          console.log(error);
        })
    ...
    CREATE_ADDITIONAL_REMARK(e) {
      ...
      formData.append("remark_type", "coil_thk");
