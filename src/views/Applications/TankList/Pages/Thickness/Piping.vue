    ...
    <div class="page-section" v-if="tabCurrent == 'A1'">
      ...
      <div class="table-wrapper">
        ...
        >
          ...
          <DxColumn data-field="piping_no" caption="Piping No." :min-width="80" />
        ...
        <div class="table-header-toolbar" style="width: calc(100% - 82px)">
          ...
          <div class="right">
            <div class="dx-table-style">
              <div class="table-toolbar-set">
                <div class="download-btn">
                  <v-ons-toolbar-button id="toolbarBTN" v-on:click="FETCH_FILE_PIPING()">
...
export default {
  ...
  methods: {
    ...
    FETCH_FILE_PIPING() {
      ...
      axios({
        method: "get",
        url: "piping-thickness/download-piping-thk?id_tag=" + id_tag,
        responseType: "blob",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        }
        ...
        .then(res => {
          const blob = res.data;
          this.downLoadFileExcel(blob, "PIPING_TP_TEMPLATE");
        })
        .catch(error => {
          console.log(error);
        })
    ...
    FETCH_FILE_CML() {
      ...
      axios({
        method: "get",
        url: "piping-thickness/download-piping-cml?id_tag=" + id_tag,
        responseType: "blob",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        }
        ...
        .then(res => {
          const blob = res.data;
          this.downLoadFileExcel(blob, "PIPING_CML_TEMPLATE");
        })
        .catch(error => {
          console.log(error);
        })
    ...
    CREATE_ADDITIONAL_REMARK(e) {
      ...
      formData.append("remark_type", "piping_thk");
