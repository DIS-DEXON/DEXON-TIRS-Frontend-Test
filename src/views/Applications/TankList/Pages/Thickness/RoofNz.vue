  ...
  <div class="page-container">
    ...
    <div class="page-section" v-if="tabCurrent == 'A1'">
      ...
      <div class="table-wrapper">
        ...
        >
          ...
          <DxColumn data-field="roofnz_no" caption="Nozzle no." :min-width="80" />
    ...
    <div id="x-page" class="page-section overflow-x" v-if="tabCurrent == 'A2'">
      <div class="table-wrapper">
        ...
        >
          ...
          <DxColumn data-field="roofnz_no" caption="Nozzle no." sort-order="asc" :width="120" :editor-options="{ 'placeholder': 'Nozzle no' }" />
    ...
    <div class="page-container" v-if="tabCurrent == 'A3' ">
      <div
        ...
        :class="[
      pagePanelHiding == false ? '' : 'page-container-hide',
    ]"
      >
...
export default {
  ...
  methods: {
    ...
    FETCH_FILE_ROOFNZ() {
      ...
      axios({
        method: "get",
        url: "roofnz-thickness/download-roof-nz-thk?id_tag=" + id_tag,
        responseType: "blob",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        }
    ...
    CREATE_ADDITIONAL_REMARK(e) {
      ...
      formData.append("remark_type", "roofnz_thk");
