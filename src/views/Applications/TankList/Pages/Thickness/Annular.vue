    ...
    <div class="page-section" v-if="tabCurrent == 'A1'">
      ...
      <div class="table-wrapper">
        ...
        >
          ...
          <DxColumn data-field="annular_no" caption="Plate No." :min-width="80" />

          <DxColumn data-field="annular_row" caption="Row" :min-width="80" />

          <DxColumn data-field="annular_column" caption="Column" :min-width="80" />

          <DxColumn data-field="tp_name" caption="TP name" :min-width="80" />
        ...
        <div class="table-header-toolbar" :style="px">
          ...
          <div class="right">
            <div class="dx-table-style">
              <div class="table-toolbar-set">
                <div class="download-btn">
                  <v-ons-toolbar-button id="toolbarBTN" v-on:click="FETCH_FILE_ANNULAR()">
...
export default {
  ...
  methods: {
    ...
    FETCH_CML() {
      ...
      axios({
        method: "post",
        url: "annular-thickness/annular-thk-cml-view-by-tank-id",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        },
        data: {
    ...
    FETCH_TP() {
      ...
      axios({
        method: "post",
        url: "annular-thickness/annular-thk-tp-by-cml",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        },
        data: {
    ...
    FETCH_THK() {
      ...
      axios({
        method: "post",
        url: "annular-thickness/annular-thk-data-by-tp",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        },
        data: {
    ...
    FETCH_VIEW() {
      ...
      axios({
        method: "post",
        url: "annular-thickness/annular-thk-view-last-insp",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        },
        data: {
    ...
    CREATE_CML(e) {
      ...
      axios({
        method: "post",
        url: "annular-thickness/add-annular-thk-cml",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        },
        data: e.data
    ...
    UPDATE_CML(e) {
      ...
      axios({
        method: "put",
        url: "annular-thickness/edit-annular-thk-cml",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        },
        data: e.data
    ...
    DELETE_CML(e) {
      ...
      axios({
        method: "delete",
        url: "annular-thickness/delete-annular-thk-cml",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        },
        data: {
    ...
    CREATE_TP(e) {
      ...
      axios({
        method: "post",
        url: "annular-thickness/add-annular-thk-tp",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        },
        data: e.data
    ...
    UPDATE_TP(e) {
      ...
      axios({
        method: "put",
        url: "annular-thickness/edit-annular-thk-tp",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        },
        data: e.data
    ...
    DELETE_TP(e) {
      ...
      axios({
        method: "delete",
        url: "annular-thickness/delete-annular-thk-tp",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        },
        data: {
    ...
    CREATE_THK(e) {
      ...
      axios({
        method: "post",
        url: "annular-thickness/add-annular-thk-data",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        },
        data: e.data
    ...
    UPDATE_THK(e) {
      ...
      axios({
        method: "put",
        url: "annular-thickness/edit-annular-thk-data",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        },
        data: e.data
    ...
    DELETE_THK(e) {
      ...
      axios({
        method: "delete",
        url: "annular-thickness/delete-annular-thk-data",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        },
        data: {
    ...
    CREATE_ADDITIONAL_REMARK(e) {
      ...
      formData.append("remark_type", "annular_thk");
