    ...
    <div class="page-section" v-if="tabCurrent == 'A1'">
      ...
      <div class="table-wrapper">
        <DxDataGrid
          ...
          @row-inserted="CREATE_ATTACHMENT"
          @row-updated="UPDATE_ATTACHMENT"
          @row-removed="DELETE_ATTACHMENT"
          @editing-start="EDITING_START_ATTACHMENT"
          @init-new-row="INIT_NEW_ROW_ATTACHMENT"
          @saved="SAVE"
        >
          <DxEditing
            :allow-updating="true"
  ...
  methods: {
    ...
    FETCH_FILE_SHELLNZ() {
      ...
      axios({
        ...
        .then(res => {
          const blob = res.data;
          this.downLoadFileExcel(blob, "ShellNozzle_TEMPLATE");
        })
        .catch(error => {
          console.log(error);
        })
