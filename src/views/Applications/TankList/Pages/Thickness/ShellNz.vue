    ...
    <div class="page-section" v-if="tabCurrent == 'A1'">
      ...
      <div class="table-wrapper">
        ...
        >
          ...
          <DxColumn data-field="shellnz_no" caption="Nozzle no." :min-width="80" />
    ...
    <div id="x-page" class="page-section overflow-x" v-if="tabCurrent == 'A2'">
      <div class="table-wrapper">
        ...
        >
          ...
          <DxColumn data-field="shellnz_no" caption="Nozzle no." sort-order="asc" :width="90" :editor-options="{ 'placeholder': 'Nozzle no' }" />

          <DxColumn data-field="nps" caption="NPS" :width="80" :editor-options="{ 'placeholder': 'NPS' }" />
        ...
        <div class="table-header-toolbar" :style="px">
          ...
          <div class="right">
            <div class="dx-table-style">
              <div class="table-toolbar-set">
                <div class="download-btn">
                  <v-ons-toolbar-button id="toolbarBTN" v-on:click="FETCH_FILE_SHELLNZ()">
...
export default {
  ...
  methods: {
    ...
    FETCH_FILE_SHELLNZ() {
      ...
      axios({
        method: "get",
        url: "shellnz-thickness/download-shell-nz-thk?id_tag=" + id_tag,
        responseType: "blob",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        }
        ...
        .then(res => {
          const blob = res.data;
          this.downLoadFileExcel(blob, "Shellnz_TP_TEMPLATE");
        })
        .catch(error => {
          console.log(error);
        })
    ...
    FETCH_FILE_CML() {
      ...
      axios({
        method: "get",
        url: "shellnz-thickness/download-shell-nz-cml?id_tag=" + id_tag,
        responseType: "blob",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        }
        ...
        .then(res => {
          const blob = res.data;
          this.downLoadFileExcel(blob, "Shellnz_CML_TEMPLATE");
        })
        .catch(error => {
          console.log(error);
        })
    ...
    CREATE_ADDITIONAL_REMARK(e) {
      ...
      formData.append("remark_type", "shellnz_thk");
