    ...
    <div class="page-section" v-if="tabCurrent == 'A1'">
      ...
      <div class="table-wrapper">
        ...
        >
          ...
          <DxColumn data-field="roof_row" caption="Roof row" :min-width="80" />

          <DxColumn data-field="roof_column" caption="Roof column" :min-width="80" />
      ...
      <div class="table-wrapper">
        ...
        >
          ...
          <DxColumn
            ...
            sort-order="asc"
            :width="120"
            :editor-options="{ 'placeholder': 'Roof row' }"
          />

          <DxColumn data-field="roof_column" caption="Roof column" sort-order="asc" :width="120" :editor-options="{ 'placeholder': 'Roof column' }" />

          <DxColumn data-field="t_nom" caption="tnom (mm)" format="#,##0.00" :width="100" :editor-options="{ 'placeholder': 'tnom' }" />
  ...
  methods: {
    ...
    FETCH_FILE_ROOF() {
      ...
      axios({
        ...
        .then(res => {
          const blob = res.data;
          this.downLoadFileExcel(blob, "Roof_TP_TEMPLATE");
        })
        .catch(error => {
          console.log(error);
        })
    ...
    FETCH_FILE_CML() {
      ...
      axios({
        method: "get",
        url: "roof-thickness/download-roof-cml?id_tag=" + id_tag,
        responseType: "blob",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        }
        ...
        .then(res => {
          const blob = res.data;
          this.downLoadFileExcel(blob, "Roof_CML_TEMPLATE");
        })
        .catch(error => {
          console.log(error);
        })
    ...
    CREATE_ADDITIONAL_REMARK(e) {
      ...
      formData.append("remark_type", "roof_thk");
