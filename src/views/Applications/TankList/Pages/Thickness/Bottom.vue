    ...
    <div class="page-section" v-if="tabCurrent == 'A1'">
      ...
      <div class="table-wrapper">
        ...
        >
          ...
          <DxColumn data-field="bottom_no" caption="Plate No." :min-width="80" />

          <DxColumn data-field="bottom_row" caption="Row" :min-width="80" />

          <DxColumn data-field="bottom_column" caption="Column" :min-width="80" />
    ...
    <div id="x-page" class="page-section overflow-x" v-if="tabCurrent == 'A2'">
      <div class="table-wrapper">
        ...
        >
          ...
          <DxColumn data-field="bottom_row" caption="Bottom row" :width="90" :editor-options="{ 'placeholder': 'Bottom row' }" />
          <DxColumn data-field="bottom_column" caption="Bottom column" :width="90" :editor-options="{ 'placeholder': 'Bottom column' }" />
  ...
  methods: {
    ...
    FETCH_FILE_BOTTOM() {
      ...
      axios({
        ...
        .then(res => {
          const blob = res.data;
          this.downLoadFileExcel(blob, "Bottom_TP_TEMPLATE");
        })
        .catch(error => {
          console.log(error);
        })
    ...
    FETCH_FILE_CML() {
      ...
      axios({
        method: "get",
        url: "bottom-thickness/download-bottom-cml?id_tag=" + id_tag,
        responseType: "blob",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        }
        ...
        .then(res => {
          const blob = res.data;
          this.downLoadFileExcel(blob, "Bottom_CML_TEMPLATE");
        })
        .catch(error => {
          console.log(error);
        })
