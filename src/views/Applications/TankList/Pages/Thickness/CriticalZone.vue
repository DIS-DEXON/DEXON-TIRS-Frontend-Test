    ...
    <div class="page-section" v-if="tabCurrent == 'A1'">
      ...
      <div class="table-wrapper">
        ...
        >
          ...
          <DxColumn data-field="plate_no" caption="Plate No." :min-width="80" />
        ...
        <div class="table-header-toolbar" :style="px">
          ...
          <div class="right">
            <div class="dx-table-style">
              <div class="table-toolbar-set">
                <div class="download-btn">
                  <v-ons-toolbar-button id="toolbarBTN" v-on:click="FETCH_FILE_CRITZONE()">
...
export default {
  ...
  methods: {
    ...
    FETCH_FILE_CRITZONE() {
      ...
      axios({
        method: "get",
        url: "critical-thickness/download-critical-thk?id_tag=" + id_tag,
        responseType: "blob",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        }
        ...
        .then(res => {
          const blob = res.data;
          this.downLoadFileExcel(blob, "Critical_TP_TEMPLATE");
        })
        .catch(error => {
          console.log(error);
        })
    ...
    FETCH_FILE_CML() {
      ...
      axios({
        method: "get",
        url: "critical-thickness/download-critical-cml?id_tag=" + id_tag,
        responseType: "blob",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token"))
        }
        ...
        .then(res => {
          const blob = res.data;
          this.downLoadFileExcel(blob, "Critical_CML_TEMPLATE");
        })
        .catch(error => {
          console.log(error);
        })
    ...
    CREATE_ADDITIONAL_REMARK(e) {
      ...
      formData.append("remark_type", "criticalZone_thk");
