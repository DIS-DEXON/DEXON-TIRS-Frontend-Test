    ...
    <div class="list-page" v-if="this.id_inspection_record != ''">
      ...
      <div>
        ...
        >
          ...
          <DxColumn data-field="defect_x" caption="X (mm)" :width="70" :editor-options="{ placeholder: 'X' }" />

          <DxColumn data-field="defect_y" caption="Y (mm)" :width="70" :editor-options="{ placeholder: 'Y' }" />
